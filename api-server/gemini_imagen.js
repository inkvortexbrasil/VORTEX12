...
async function generateImageWithGemini(prompt, outputPath) {
    ...
    // Prompt enriquecido com qualidade cinematográfica 8K para YouTube
    const enhancedPrompt = `${prompt}, 8k resolution, cinematic documentary photography, masterclass lighting, photorealistic, highly detailed, 16:9 widescreen format`;
    ...
    const payload = {
        ...
        parameters: {
            sampleCount: 1,
            aspectRatio: "16:9" // Formato Widescreen 16:9 para Documentários YouTube 8K
        }
    };
